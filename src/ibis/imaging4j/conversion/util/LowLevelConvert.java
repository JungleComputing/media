...
public class LowLevelConvert {
    ...
    public static void YUYVtoARGB32Table(int width, int height, ByteBuffer in, ByteBuffer out) {
    ...
    public static void YUYVtoARGB32Table2(int width, int height, ByteBuffer in, ByteBuffer out) {
    ...
    public static void YUYVtoRGB24Table(int width, int height, ByteBuffer in, ByteBuffer out) {
